...
class RipperRooBuilderSourceTests(unittest.TestCase):
    ...
    def test_ripper_roo_driver_entry_stays_fallback(self) -> None:
        # The gate is human-only (repo rule 3 / this plan's own Global
        # Constraints) -- this builder must never be the thing that flips
        # ripper_roo.tres. Reading it here pins the current, correct state
        # and would catch an accidental flip landing in the SAME commit as
        # this builder.
